...
public class AdminController {
   ...
   @PostMapping(value = "/adminloginaction")
	  ...
	  @RequestMapping(value = "/adminchangepwdaction", method = RequestMethod.POST)
	    public String updatePassword(ModelMap map, javax.servlet.http.HttpServletRequest request,  @RequestParam(value="pwd", required=true) String pwd,
	  ...
	  @RequestMapping(value = "/admindeletecat",  method = RequestMethod.GET)
	    public String deleteCategory(ModelMap map, javax.servlet.http.HttpServletRequest request, @RequestParam(value="id", required=true) String id) 
	    {
		  // check if session is still alive
		  HttpSession session = request.getSession();
		  if (session.getAttribute("admin_id") == null) {
	  ...
	  @RequestMapping(value = "/admineditcat",  method = RequestMethod.GET)
	    public String editCategory(ModelMap map,javax.servlet.http.HttpServletRequest request,  @RequestParam(value="id", required=true) String id) 
	    {
		  // check if session is still alive
		  HttpSession session = request.getSession();
		  if (session.getAttribute("admin_id") == null) {
	  ...
	  @RequestMapping(value = "/admineditcataction", method = RequestMethod.POST)
	    public String updateCategory(ModelMap map,javax.servlet.http.HttpServletRequest request,   @RequestParam(value="id", required=true) String id,
	  ...
	  @RequestMapping(value = "/admindeleteproduct",  method = RequestMethod.GET)
	    public String deleteProduct(ModelMap map,javax.servlet.http.HttpServletRequest request,   @RequestParam(value="id", required=true) String id) 
	    {
		  // check if session is still alive
		  HttpSession session = request.getSession();
		  if (session.getAttribute("admin_id") == null) {
	  ...
	  @RequestMapping(value = "/admineditproduct",  method = RequestMethod.GET)
	    public String editProduct(ModelMap map, javax.servlet.http.HttpServletRequest request, @RequestParam(value="id", required=true) String id) 
	    {
		  // check if session is still alive
		  HttpSession session = request.getSession();
		  if (session.getAttribute("admin_id") == null) {
